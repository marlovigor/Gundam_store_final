    ...
    render() {
        return (
            <div>  
                ...
                <br/>
                <Popup trigger={<h2>Instructions</h2>} closeOnDocumentClick contentStyle={{width: "80%", borderRadius:'30px', backgroundColor:'grey', padding:'12px'}}  position="bottom center">
